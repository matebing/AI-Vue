  ...
  <div class="articleDetail-container">
    ...
    <div class="content">
      <div class="diary-card">
        ...
        <div class="sub-title">
          <el-tag plain size="large" class="category-tag">{{
...
import { formatContent } from "@/utils/utils.js";
...
const queryArticleDetail = () => {
  getArticleDetail(route.params.id || props.id).then((res) => {
    articleDetail.value = res;
    console.log("响应", res, articleDetail.value);
  });
};

onMounted(() => {
  console.log("路由参数", route.params.id, "props参数", props.id);
  queryArticleDetail();
});
</script>
