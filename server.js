...
// 获取数据分析
app.get("/data-analytics/overview", (req, res) => {
  const data = {
    code: "200",
    msg: "操作成功",
    data: {
      ...
      emotionHeatmap: {
        ...
        peakEmotionTime: "18:00",
        dateRange: "2026-06-22 至 2026-07-21",
      },
      emotionTrend: [
        {
          date: "2026-06-22",
